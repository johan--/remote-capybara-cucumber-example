...
module EmailHelpers
  def current_email_address
    ...
    @current_email || @current_user.try(:email) || "newuser@mail.com" 
#    @current_email || @current_user.try(:email) #|| "example@example.com"
  end
end
...
When /^(?:I|they) follows? "([^"]*?)" in the email$/ do |link|
  visit_in_email(link)
end
...
Then /^no emails should be sent$/ do
